...
{
  $('#first').fadeOut(100);
  $.cookie('site_joaoanes', 'hello! thanks for visiting! drop me an email!', {expires: 365, path: '/'});
}
...
$(".skills_masonry").data('masonry');
  ...
  *****************************/
  ...
  $('#side_menu').hover(function(){$(this).css("left", "0"); $("#side_menu_tutorial").fadeOut(500);}, function(){
  ...
  {
    $($(this).children()[2]).animate({right: "-170"}, 100);
    $($($(this).children()[1]).children()[0]).fadeOut(100);
  },
  function(){
    $($(this).children()[2]).animate({right: "0"}, 100);
  ...
  $('.container_image.cool').hover(function()
  {
    ...
    $(this).animate({"width": "700px", "height": "700px"}, 500);
  ...
  }, function()
  {
    ...
    $(this).animate({"width": "350px", "height": "350px"}, 500, function(){
...
function updateImageWall()
{
    ...
    isFitWidth: true,
            isOriginTop: false
              ...
              var delay = (function(){if (index < 5) return 0; else return (index*0.10);});
              var sup = this;
              setTimeout(function(){
