export const store = {
  ...
  description: [
    ...
    "Firm believer in strong teams that own their features, and increasingly in building the machinery that lets those teams use AI without setting the place on fire.",
  ],
  lookingFor:
  ...
  history: [
    {
      role: "Staff Software Engineer - AI Engineering & Enablement",
      date: "2025-present",
      current: true,
      companyName: "Mindera",
      ...
      whatDo:
        "Build AI-powered engineering tools and agent systems, coach teams on using them and help shape how they fit into normal software development without forgetting the normal software development part.",
      blurbs: [
        ...
        "Built eval tooling and quality gates to compare model and agent behaviour without relying exclusively on vibes",
        ...
        "Built documentation tracing systems connecting requirements, architecture, implementation and supporting knowledge",
    ...
    },
    {
      ...
      whatDo:
        "Fully embedded in a client warehousing team, building support systems and automation while helping the team deliver and improve its engineering practices.",
      blurbs: [
